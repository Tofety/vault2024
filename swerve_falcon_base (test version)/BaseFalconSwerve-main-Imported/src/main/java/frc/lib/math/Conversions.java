...
public class Conversions {
     ...
     * @return Degrees of Rotation of Mechanism
     */
    public static double falconToDegrees(StatusSignal<Double> statusSignal, double gearRatio) {
        return statusSignal * (360.0 / (gearRatio * 2048.0));
    }
    ...
    /**
     * @param statusSignal Falcon Position Counts
     * @param circumference Circumference of Wheel
     * @param gearRatio Gear Ratio between Falcon and Wheel
     * @return Meters
     */
    public static double falconToMeters(StatusSignal<Double> statusSignal, double circumference, double gearRatio){
        return statusSignal * (circumference / (gearRatio * 2048.0));
    }
