...
public class RobotContainer {
    ...
    Trigger AutoShooterButton = new JoystickButton(driver, 5);
    ...
    public RobotContainer() {
        ...
        AutoShooterButton.onTrue(s_Intake_Shooter.AutoShooterCommand());
        AutoShooterButton.onFalse(s_Intake_Shooter.stopShooterCommand());
        ...
        NamedCommands.registerCommand("Reset Gyro", s_Swerve.zeroGyroCommand());
        //autoChooser
